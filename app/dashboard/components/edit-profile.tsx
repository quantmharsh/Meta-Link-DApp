...
try {
 ...
 const onSubmit = async (e: React.FormEvent) => {
  ...
  try {
    const basicInfo = {
        firstName: formData.first_name || "", // Ensure it's never undefined
      ...
      const professionalInfo = {
        ...
        info: formData.info || "",
        skills: Array.isArray(formData.skills) ? formData.skills : [], // Ensure it's an array
    ...
    console.log("SocialLinks sending to Edit User " ,socialLinks);
  ...
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start justify-between space-y-4 md:space-y-0 md:space-x-10 pt-3 pb-20 px-4 md:px-16">
      <div>
       ...
       Edit Your Profile anytime , anywhere with    { " "}
