...
🔗 **Check out the deployed project:** [MetaLink DApp](https://mlinkdapp.netlify.app/)
...
```bash
git clone https://github.com/quantmharsh/Meta-Link-DApp.git
...
The main contract, `metaLink`, manages user profiles, DIDs, and credentials.
...
We welcome contributions to metaLink! To contribute, please follow these steps:
